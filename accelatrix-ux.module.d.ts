declare global {
    ...
    export interface IHtmlEventListener {
        /**
    ...
    export interface HTMLDocument extends IHtmlEventListener {
        /**
         * Finds nested elements based on a selector.
         * @param selector The selector for nested elements.
         */
    ...
    export interface Document extends IHtmlEventListener {
        /**
         * Finds nested elements based on a selector.
         * @param selector The selector for nested elements.
         */
    ...
    export interface HTMLDocumentConstructor extends IHtmlEventListener {
    }
    /** A DOM node that is an HTML element. */
    export interface HTMLElement extends IHtmlEventListener {
        /**
         * Finds nested elements based on a selector.
         * @param selector The selector for nested elements.
         */
    ...
    export interface Window extends IHtmlEventListener {
    }
    /** A generic HTML node. */
...
export declare namespace Accelatrix {
    ...
    namespace StateManagement {
         ...
         */
        export interface ITreeNotification {
            /**
         ...
         */
        export interface IPropertyChangedNotification extends ITreeNotification {
            /**
